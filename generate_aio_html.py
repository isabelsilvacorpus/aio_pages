...
def main() -> None:
    ...
    ap.add_argument("--retrievals", default="pilot_samples_v3_2026/retrievals_formatted.csv", type=str)
    ap.add_argument("--sources", default="pilot_samples_v3_2026/aio_sources.csv", type=str)
    ap.add_argument("--out_dir", default="pilot_v3_aio", type=str)
