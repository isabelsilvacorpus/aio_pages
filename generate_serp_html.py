...
def main() -> None:
    ...
    ap.add_argument("--sources", default="pilot_samples_v3_2026/serps.csv", help="CSV of sources (supports aio_sources.csv or serps.csv schema)")
    ap.add_argument("--out_dir", default="pilot_v3_serp")
